...
export default function ItemCount(props) {
  ...
  return (
    <>
      ...
      <button className="py-2 px-4 bg-cyan-500 text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 mt-4 w-full flex items-center justify-center">
        Agregar al carrito
      </button>
    </>
  );
